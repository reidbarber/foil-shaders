...
extension SmokeRingPreset {
  public static let `default`: SmokeRingPreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let line: SmokeRingPreset =
    ShaderPreset(
      name: "Line",
      params: SmokeRingParams(
        colorBack: color("#000000"),
  ...
  public static let solar: SmokeRingPreset =
    ShaderPreset(
      name: "Solar",
      params: SmokeRingParams(
        colorBack: color("#000000"),
  ...
  public static let cloud: SmokeRingPreset =
    ShaderPreset(
      name: "Cloud",
      params: SmokeRingParams(
...
let smokeRingPresets: [SmokeRingPreset] = [
  .default, .line, .solar, .cloud,
]

extension NeuroNoisePreset {
  public static let `default`: NeuroNoisePreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let sensation: NeuroNoisePreset =
    ShaderPreset(
      name: "Sensation",
      params: NeuroNoiseParams(
  ...
  public static let bloodstream: NeuroNoisePreset =
    ShaderPreset(
      name: "Bloodstream",
      params: NeuroNoiseParams(
  ...
  public static let ghost: NeuroNoisePreset =
    ShaderPreset(
      name: "Ghost",
      params: NeuroNoiseParams(
        colorFront: color("#ffffff"),
...
let neuroNoisePresets: [NeuroNoisePreset] = [
  .default, .sensation, .bloodstream, .ghost,
]

extension DotOrbitPreset {
  public static let `default`: DotOrbitPreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let bubbles: DotOrbitPreset =
    ShaderPreset(
      name: "Bubbles",
      params: DotOrbitParams(
  ...
  public static let shine: DotOrbitPreset =
    ShaderPreset(
      name: "Shine",
      params: DotOrbitParams(
        colorBack: color("#000000"),
  ...
  public static let hallucinatory: DotOrbitPreset =
    ShaderPreset(
      name: "Hallucinatory",
      params: DotOrbitParams(
...
let dotOrbitPresets: [DotOrbitPreset] = [
  .default, .bubbles, .shine, .hallucinatory,
]

extension DotGridPreset {
  public static let `default`: DotGridPreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let triangles: DotGridPreset =
    ShaderPreset(
      name: "Triangles",
      params: DotGridParams(
        colorBack: color("#ffffff"),
  ...
  public static let treeLine: DotGridPreset =
    ShaderPreset(
      name: "Tree line",
      params: DotGridParams(
  ...
  public static let wallpaper: DotGridPreset =
    ShaderPreset(
      name: "Wallpaper",
      params: DotGridParams(
...
let dotGridPresets: [DotGridPreset] = [
  .default, .triangles, .treeLine, .wallpaper,
]

extension SimplexNoisePreset {
  public static let `default`: SimplexNoisePreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let spots: SimplexNoisePreset =
    ShaderPreset(
      name: "Spots",
      params: SimplexNoiseParams(
  ...
  public static let firstContact: SimplexNoisePreset =
    ShaderPreset(
      name: "First contact",
      params: SimplexNoiseParams(
        colors: [
  ...
  public static let bubblegum: SimplexNoisePreset =
    ShaderPreset(
      name: "Bubblegum",
      params: SimplexNoiseParams(
...
let simplexNoisePresets: [SimplexNoisePreset] = [
  .default, .spots, .firstContact, .bubblegum,
]

extension MetaballsPreset {
  public static let `default`: MetaballsPreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let inkDrops: MetaballsPreset =
    ShaderPreset(
      name: "Ink Drops",
      params: MetaballsParams(
  ...
  public static let solar: MetaballsPreset =
    ShaderPreset(
      name: "Solar",
      params: MetaballsParams(
  ...
  public static let background: MetaballsPreset =
    ShaderPreset(
      name: "Background",
      params: MetaballsParams(
...
let metaballsPresets: [MetaballsPreset] = [
  .default, .inkDrops, .solar, .background,
]

extension WavesPreset {
  public static let `default`: WavesPreset =
    ShaderPreset(
      name: "Default",
      params: WavesParams(
  ...
  public static let groovy: WavesPreset =
    ShaderPreset(
      name: "Groovy",
      params: WavesParams(
  ...
  public static let tangledUp: WavesPreset =
    ShaderPreset(
      name: "Tangled up",
      params: WavesParams(
  ...
  public static let rideTheWave: WavesPreset =
    ShaderPreset(
      name: "Ride the wave",
      params: WavesParams(
...
let wavesPresets: [WavesPreset] = [
  .default, .groovy, .tangledUp, .rideTheWave,
]

extension PerlinNoisePreset {
  public static let `default`: PerlinNoisePreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let nintendoWater: PerlinNoisePreset =
    ShaderPreset(
      name: "Nintendo Water",
      params: PerlinNoiseParams(
  ...
  public static let moss: PerlinNoisePreset =
    ShaderPreset(
      name: "Moss",
      params: PerlinNoiseParams(
  ...
  public static let worms: PerlinNoisePreset =
    ShaderPreset(
      name: "Worms",
      params: PerlinNoiseParams(
...
let perlinNoisePresets: [PerlinNoisePreset] = [
  .default, .nintendoWater, .moss, .worms,
]

extension VoronoiPreset {
  public static let `default`: VoronoiPreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let lights: VoronoiPreset =
    ShaderPreset(
      name: "Lights",
      params: VoronoiParams(
  ...
  public static let cells: VoronoiPreset =
    ShaderPreset(
      name: "Cells",
      params: VoronoiParams(
        colors: [color("#ffffff")],
  ...
  public static let bubbles: VoronoiPreset =
    ShaderPreset(
      name: "Bubbles",
      params: VoronoiParams(
        colors: [color("#83c9fb")],
...
let voronoiPresets: [VoronoiPreset] = [
  .default, .lights, .cells, .bubbles,
]

extension WarpPreset {
  public static let `default`: WarpPreset =
    ShaderPreset(
      name: "Default",
      params: WarpParams(
  ...
  public static let cauldronPot: WarpPreset =
    ShaderPreset(
      name: "Cauldron Pot",
      params: WarpParams(
  ...
  public static let liveInk: WarpPreset =
    ShaderPreset(
      name: "Live Ink",
      params: WarpParams(
  ...
  public static let kelp: WarpPreset =
    ShaderPreset(
      name: "Kelp",
      params: WarpParams(
  ...
  public static let nectar: WarpPreset =
    ShaderPreset(
      name: "Nectar",
      params: WarpParams(
  ...
  public static let passion: WarpPreset =
    ShaderPreset(
      name: "Passion",
      params: WarpParams(
...
let warpPresets: [WarpPreset] = [
  .default, .cauldronPot, .liveInk, .kelp, .nectar, .passion,
]

extension GodRaysPreset {
  public static let `default`: GodRaysPreset =
    ShaderPreset(
      name: "Default",
      ...
      sizing: ShaderSizingParams(
        fit: .contain, scale: 1, rotation: 0, originX: 0.5, originY: 0.5, offsetX: 0,
        offsetY: -0.55,
        worldWidth: 0, worldHeight: 0),
      motion: ShaderMotionParams(speed: 0.75, frame: 0)
    )

  public static let warp: GodRaysPreset =
    ShaderPreset(
      name: "Warp",
      params: GodRaysParams(
        colorBack: color("#000000"),
  ...
  public static let linear: GodRaysPreset =
    ShaderPreset(
      name: "Linear",
      params: GodRaysParams(
        colorBack: color("#000000"),
      ...
      sizing: ShaderSizingParams(
        fit: .contain, scale: 1, rotation: 0, originX: 0.5, originY: 0.5, offsetX: 0.2,
        offsetY: -0.8,
        worldWidth: 0, worldHeight: 0),
      motion: ShaderMotionParams(speed: 0.5, frame: 0)
    )

  public static let ether: GodRaysPreset =
    ShaderPreset(
      name: "Ether",
      params: GodRaysParams(
...
let godRaysPresets: [GodRaysPreset] = [
  .default, .warp, .linear, .ether,
]

extension SpiralPreset {
  public static let `default`: SpiralPreset =
    ShaderPreset(
      name: "Default",
      params: SpiralParams(
  ...
  public static let jungle: SpiralPreset =
    ShaderPreset(
      name: "Jungle",
      params: SpiralParams(
  ...
  public static let droplet: SpiralPreset =
    ShaderPreset(
      name: "Droplet",
      params: SpiralParams(
  ...
  public static let swirl: SpiralPreset =
    ShaderPreset(
      name: "Swirl",
      params: SpiralParams(
...
let spiralPresets: [SpiralPreset] = [
  .default, .jungle, .droplet, .swirl,
]

extension SwirlPreset {
  public static let `default`: SwirlPreset =
    ShaderPreset(
      name: "Default",
      params: SwirlParams(
  ...
  public static let preset007: SwirlPreset =
    ShaderPreset(
      name: "007",
      params: SwirlParams(
  ...
  public static let opening: SwirlPreset =
    ShaderPreset(
      name: "Opening",
      params: SwirlParams(
  ...
  public static let candy: SwirlPreset =
    ShaderPreset(
      name: "Candy",
      params: SwirlParams(
...
let swirlPresets: [SwirlPreset] = [
  .default, .preset007, .opening, .candy,
]

extension DitheringPreset {
  public static let `default`: DitheringPreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let warp: DitheringPreset =
    ShaderPreset(
      name: "Warp",
      params: DitheringParams(
  ...
  public static let sineWave: DitheringPreset =
    ShaderPreset(
      name: "Sine Wave",
      params: DitheringParams(
  ...
  public static let ripple: DitheringPreset =
    ShaderPreset(
      name: "Ripple",
      params: DitheringParams(
  ...
  public static let bugs: DitheringPreset =
    ShaderPreset(
      name: "Bugs",
      params: DitheringParams(
        colorBack: color("#000000"),
  ...
  public static let swirl: DitheringPreset =
    ShaderPreset(
      name: "Swirl",
      params: DitheringParams(
...
let ditheringPresets: [DitheringPreset] = [
  .default, .warp, .sineWave, .ripple, .bugs, .swirl,
]

extension GrainGradientPreset {
  public static let `default`: GrainGradientPreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let wave: GrainGradientPreset =
    ShaderPreset(
      name: "Wave",
      params: GrainGradientParams(
  ...
  public static let dots: GrainGradientPreset =
    ShaderPreset(
      name: "Dots",
      params: GrainGradientParams(
  ...
  public static let truchet: GrainGradientPreset =
    ShaderPreset(
      name: "Truchet",
      params: GrainGradientParams(
        colorBack: color("#0a0000"),
  ...
  public static let ripple: GrainGradientPreset =
    ShaderPreset(
      name: "Ripple",
      params: GrainGradientParams(
  ...
  public static let blob: GrainGradientPreset =
    ShaderPreset(
      name: "Blob",
      params: GrainGradientParams(
...
let grainGradientPresets: [GrainGradientPreset] = [
  .default, .wave, .dots, .truchet, .ripple, .blob,
]

extension PulsingBorderPreset {
  public static let `default`: PulsingBorderPreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let circle: PulsingBorderPreset =
    ShaderPreset(
      name: "Circle",
      params: PulsingBorderParams(
        colorBack: color("#000000"),
  ...
  public static let northernLights: PulsingBorderPreset =
    ShaderPreset(
  ...
  public static let solidLine: PulsingBorderPreset =
    ShaderPreset(
      name: "Solid line",
      params: PulsingBorderParams(
        colorBack: color("#00000000"),
...
let pulsingBorderPresets: [PulsingBorderPreset] = [
  .default, .circle, .northernLights, .solidLine,
]

extension ColorPanelsPreset {
  public static let `default`: ColorPanelsPreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let glass: ColorPanelsPreset =
    ShaderPreset(
      name: "Glass",
      params: ColorPanelsParams(
  ...
  public static let gradient: ColorPanelsPreset =
    ShaderPreset(
      name: "Gradient",
      params: ColorPanelsParams(
        colors: [
  ...
  public static let opening: ColorPanelsPreset =
    ShaderPreset(
      name: "Opening",
      params: ColorPanelsParams(
        colors: [color("#00ffff")],
...
let colorPanelsPresets: [ColorPanelsPreset] = [
  .default, .glass, .gradient, .opening,
]

extension StaticMeshGradientPreset {
  public static let `default`: StaticMeshGradientPreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let preset1960s: StaticMeshGradientPreset =
    ShaderPreset(
      name: "1960s",
      params: StaticMeshGradientParams(
  ...
  public static let sunset: StaticMeshGradientPreset =
    ShaderPreset(
      name: "Sunset",
      params: StaticMeshGradientParams(
  ...
  public static let sea: StaticMeshGradientPreset =
    ShaderPreset(
      name: "Sea",
      params: StaticMeshGradientParams(
...
let staticMeshGradientPresets: [StaticMeshGradientPreset] = [
  .default, .preset1960s, .sunset, .sea,
]

extension StaticRadialGradientPreset {
  public static let `default`: StaticRadialGradientPreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let loFi: StaticRadialGradientPreset =
    ShaderPreset(
      name: "Lo-Fi",
      params: StaticRadialGradientParams(
  ...
  public static let crossSection: StaticRadialGradientPreset =
    ShaderPreset(
      name: "Cross Section",
      params: StaticRadialGradientParams(
  ...
  public static let radial: StaticRadialGradientPreset =
    ShaderPreset(
      name: "Radial",
      params: StaticRadialGradientParams(
...
let staticRadialGradientPresets: [StaticRadialGradientPreset] = [
  .default, .loFi, .crossSection, .radial,
]

extension PaperTexturePreset {
  public static let `default`: PaperTexturePreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let cardboard: PaperTexturePreset =
    ShaderPreset(
      name: "Cardboard",
      params: PaperTextureParams(
  ...
  public static let abstract: PaperTexturePreset =
    ShaderPreset(
      name: "Abstract",
      params: PaperTextureParams(
  ...
  public static let details: PaperTexturePreset =
    ShaderPreset(
      name: "Details",
      params: PaperTextureParams(
...
let paperTexturePresets: [PaperTexturePreset] = [
  .default, .cardboard, .abstract, .details,
]

extension FlutedGlassPreset {
  public static let `default`: FlutedGlassPreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let abstract: FlutedGlassPreset =
    ShaderPreset(
      name: "Abstract",
      params: FlutedGlassParams(
        colorBack: color("#00000000"),
  ...
  public static let waves: FlutedGlassPreset =
    ShaderPreset(
      name: "Waves",
      params: FlutedGlassParams(
        colorBack: color("#00000000"),
  ...
  public static let folds: FlutedGlassPreset =
    ShaderPreset(
      name: "Folds",
      params: FlutedGlassParams(
        colorBack: color("#00000000"),
...
let flutedGlassPresets: [FlutedGlassPreset] = [
  .default, .abstract, .waves, .folds,
]

extension WaterPreset {
  public static let `default`: WaterPreset =
    ShaderPreset(
      name: "Default",
      params: WaterParams(
  ...
  public static let slowMo: WaterPreset =
    ShaderPreset(
      name: "Slow-mo",
      params: WaterParams(
        colorBack: color("#909090"),
  ...
  public static let abstract: WaterPreset =
    ShaderPreset(
      name: "Abstract",
      params: WaterParams(
        colorBack: color("#909090"),
  ...
  public static let streaming: WaterPreset =
    ShaderPreset(
      name: "Streaming",
      params: WaterParams(
        colorBack: color("#909090"),
...
let waterPresets: [WaterPreset] = [
  .default, .slowMo, .abstract, .streaming,
]

extension ImageDitheringPreset {
  public static let `default`: ImageDitheringPreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let noise: ImageDitheringPreset =
    ShaderPreset(
      name: "Noise",
      params: ImageDitheringParams(
  ...
  public static let retro: ImageDitheringPreset =
    ShaderPreset(
      name: "Retro",
      params: ImageDitheringParams(
  ...
  public static let natural: ImageDitheringPreset =
    ShaderPreset(
      name: "Natural",
      params: ImageDitheringParams(
        colorFront: color("#ffffff"),
...
let imageDitheringPresets: [ImageDitheringPreset] = [
  .default, .noise, .retro, .natural,
]

extension HeatmapPreset {
  public static let `default`: HeatmapPreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let sepia: HeatmapPreset =
    ShaderPreset(
      name: "Sepia",
      params: HeatmapParams(
        colorBack: color("#000000"),
...
let heatmapPresets: [HeatmapPreset] = [
  .default, .sepia,
]

extension LiquidMetalPreset {
  public static let `default`: LiquidMetalPreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let noir: LiquidMetalPreset =
    ShaderPreset(
      name: "Noir",
      params: LiquidMetalParams(
        colorBack: color("#000000"),
  ...
  public static let backdrop: LiquidMetalPreset =
    ShaderPreset(
      name: "Backdrop",
      params: LiquidMetalParams(
        colorBack: color("#AAAAAC"),
  ...
  public static let stripes: LiquidMetalPreset =
    ShaderPreset(
      name: "Stripes",
      params: LiquidMetalParams(
        colorBack: color("#000000"),
...
let liquidMetalPresets: [LiquidMetalPreset] = [
  .default, .noir, .backdrop, .stripes,
]

extension HalftoneDotsPreset {
  public static let `default`: HalftoneDotsPreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let ledScreen: HalftoneDotsPreset =
    ShaderPreset(
      name: "LED screen",
      params: HalftoneDotsParams(
  ...
  public static let mosaic: HalftoneDotsPreset =
    ShaderPreset(
      name: "Mosaic",
      params: HalftoneDotsParams(
  ...
  public static let roundAndSquare: HalftoneDotsPreset =
    ShaderPreset(
...
let halftoneDotsPresets: [HalftoneDotsPreset] = [
...
extension GemSmokePreset {
  public static let `default`: GemSmokePreset =
    ShaderPreset(
      name: "Default",
  ...
  public static let fire: GemSmokePreset =
    ShaderPreset(
      name: "Fire",
      params: GemSmokeParams(
  ...
  public static let fluorescent: GemSmokePreset =
    ShaderPreset(
      name: "Fluorescent",
      params: GemSmokeParams(
  ...
  public static let infrared: GemSmokePreset =
    ShaderPreset(
      name: "Infrared",
      params: GemSmokeParams(
        colors: [
...
let gemSmokePresets: [GemSmokePreset] = [
  .default, .fire, .fluorescent, .infrared,
]
